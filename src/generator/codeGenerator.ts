...
import {generateDefaultValue, generateType, getDefaultEntityName} from './utils';
...
export function generateTypeScriptFile(collections: CollectionDef[]): string {
  return header + generateCollectionDefs(collections) + generateDocumentTypes(collections);
}
